...
use super::{amount_to_u128_shift, brc20_self_mint_activation_height};
...
pub async fn verify_brc20_operation(
    ...
    match operation {
        ParsedBrc20Operation::Deploy(data) => {
            ...
            return Ok(Some(VerifiedBrc20Operation::TokenDeploy(
                VerifiedBrc20TokenDeployData {
                    ...
                    max: amount_to_u128_shift(&data.max, decimals),
                    lim: amount_to_u128_shift(&data.lim, decimals),
                    dec: decimals,
        ...
        ParsedBrc20Operation::Mint(data) => {
            ...
            let amount = amount_to_u128_shift(&data.amt, token.decimals.0);
